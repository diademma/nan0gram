(function(W) {
    ...
    // =========================================================================
    // ЕДИНАЯ ТАБЛИЦА ТИПОВ СООБЩЕНИЙ (wire-формат, схема v1)
    // Одна точка правды для JS-слоя. Зеркало: MsgTypes.kt (Kotlin)
    // ПРАВИЛО: изменения здесь → синхронно в MsgTypes.kt, и наоборот.
    //
    ...
    // Краткие имена полей wire-блоков (экономим байты в письме)
    W.MSG_F = {
        REF:  "ref",
        EMOJI:"e",
        PIN:  "p",
